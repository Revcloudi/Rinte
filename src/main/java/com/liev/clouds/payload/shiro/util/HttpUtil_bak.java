...
public class HttpUtil_bak {
    ...
    public static Map sendGetRequestWithCookie(String urlPath, String cookie, Integer timeout) throws Exception {
        ...
        Proxy proxys = (proxyConfig != null && proxyConfig.getProxy() != Proxy.NO_PROXY) ? proxyConfig.getProxy() : Proxy.NO_PROXY;
        if (proxys != null) {
            Proxy proxy = proxys;
    ...
    public static void disableSslVerification() {
        try {
            ...
            HttpsURLConnection.setDefaultSSLSocketFactory(new MySSLSocketFactory(sc.getSocketFactory(), (String[])((String[])cipherSuites.toArray(new String[0]))));
